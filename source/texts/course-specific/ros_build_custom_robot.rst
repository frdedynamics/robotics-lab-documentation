...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
.. literalinclude:: ../../_static/scripts/build_custom_robot/link_box_macro.urdf.xacro
      :language: XML
      :caption: xacro macro definition for box link object

Box Macro Usage
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
.. literalinclude:: ../../_static/scripts/build_custom_robot/link_box_macro_usage.urdf.xacro
      :language: XML
      :caption: xacro macro usage for box link object
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
.. literalinclude:: ../../_static/scripts/build_custom_robot/link_cylinder_macro.urdf.xacro
      :language: XML
      :caption: xacro macro definition for cylinder link object

Cylinder Macro Usage
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
.. literalinclude:: ../../_static/scripts/build_custom_robot/link_cylinder_macro_usage.urdf.xacro
      :language: XML
      :caption: xacro macro usage for cylinder link object
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
.. literalinclude:: ../../_static/scripts/build_custom_robot/link_sphere_macro.urdf.xacro
      :language: XML
      :caption: xacro macro definition for sphere link object

Sphere Macro Usage
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
.. literalinclude:: ../../_static/scripts/build_custom_robot/link_sphere_macro_usage.urdf.xacro
      :language: XML
      :caption: xacro macro usage for sphere link object
...
Exercise
---------------------
Download the ROS package used for the exercise from this `link <https://hvl365.sharepoint.com/:f:/s/RobotikkUndervisningHVL/Et9UoyBoCqtGjodHxIuoxyIBkuRFPaZ-urvJNkp7NOIImQ?e=PO00cb>`_. After unzipping it, copy it to the VM in catkin_ws/src/. Run the following commands in a terminal window:
