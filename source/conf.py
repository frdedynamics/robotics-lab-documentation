...
# -*- coding: utf-8 -*-
#
# HVL Robotics Førde documentation build configuration file, created by
...
# html_theme = "classic" -- Changed because of a bug in sphinx_rtd_theme in using bullets
...
# of the sidebar.
html_logo = "_static/hvl_logo_opac.png"
...
html_context = {
    "display_github": True,
    "github_user": "frdedynamics",
    "github_repo": "robotics-lab-documentation",
}
...
htmlhelp_basename = 'HVLRoboticsFrdedoc'
